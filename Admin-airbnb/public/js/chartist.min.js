...
! function(a, b) {
    ...
    return function(a, b, c) {
            ...
            c.noop = function(a) {
                ...
                function e(a) {
                    return c.isFalseyButZero(a) ? void 0 : (a.data || a) instanceof Array ? (a.data || a).map(e) : a.hasOwnProperty("value") ? e(a.value) : d ? {
                        x: c.getNumberOrUndefined(a.x),
                        y: c.getNumberOrUndefined(a.hasOwnProperty("y") ? a.y : a)
                ...
                var f = {
                    ...
                    g = void 0 === b.high,
                    h = void 0 === b.low;
                return (g || h) && e(a), f.high <= f.low && (0 === f.low ? f.high = 1 : f.low < 0 ? f.high = 0 : f.low = 0), f
            }, c.isNum = function(a) {
                ...
                (e || 0 === e) && (k.high = Math.max(e, k.high), k.low = Math.min(e, k.low)), k.valueRange = k.high - k.low, k.oom = c.orderOfMagnitude(k.valueRange), k.step = Math.pow(10, k.oom), k.min = Math.floor(k.low / k.step) * k.step, k.max = Math.ceil(k.high / k.step) * k.step, k.range = k.max - k.min, k.numberOfSteps = Math.round(k.range / k.step);
                var l = c.projectLength(a, k.step, k),
                    m = d > l,
                    n = f ? c.rho(k.range) : 0;
                if (f && c.projectLength(a, 1, k) >= d) k.step = 1;
                else if (f && n < k.step && c.projectLength(a, n, k) >= d) k.step = n;
                else
                    for (;;) {
                        if (m && c.projectLength(a, k.step, k) <= d) k.step *= 2;
                        else {
                            if (m || !(c.projectLength(a, k.step / 2, k) >= d)) break;
                            if (k.step /= 2, f && k.step % 1 !== 0) {
                                k.step *= 2;
                                break
                            }
                        }
                ...
                for (h = k.min, i = k.max; h + k.step <= k.low;) h += k.step;
                for (; i - k.step >= k.high;) i -= k.step;
                for (k.min = h, k.max = i, k.range = k.max - k.min, k.values = [], g = k.min; g <= k.max; g += k.step) k.values.push(c.roundWithPrecision(g));
                return k
        ...
        function(a, b, c) {
            ...
            function d(a, b, d, e) {
                this.highLow = e.highLow || c.getHighLow(b.normalized, e, a.pos), this.bounds = c.getBounds(d[a.rectEnd] - d[a.rectStart], this.highLow, e.scaleMinSpace || 20, e.referenceValue, e.onlyInteger), c.AutoScaleAxis["super"].constructor.call(this, a, d, this.bounds.values, e)
            }
        ...
        function(a, b, c) {
            ...
            function d(a, b, d, e) {
                this.highLow = c.getHighLow(b.normalized, e, a.pos), this.divisor = e.divisor || 1, this.ticks = e.ticks || c.times(this.divisor).map(function(a, b) {
                    return this.highLow.low + (this.highLow.high - this.highLow.low) / this.divisor * b
                }.bind(this)), c.FixedScaleAxis["super"].constructor.call(this, a, d, this.ticks, e), this.stepLength = this.axisLength / this.divisor
            }

            function e(a) {
                return this.axisLength * (+c.getMultiValue(a, this.units.pos) - this.highLow.low) / (this.highLow.high - this.highLow.low)
            }
                ...
                d = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b, j, c.extend({}, a.axisX, {
                    ...
                    if (m.showPoint && o.pathElements.forEach(function(b) {
                            var d = i.elem("line", {
                                ...
                                value: void 0 === b.data.value.x ? b.data.value.y : b.data.value.x + "," + b.data.value.y,
                                meta: b.data.meta
                            }, c.xmlNs.uri);
                    ...
                    if (m.showArea && e.highLow) {
                        var q = Math.max(Math.min(m.areaBase, e.highLow.high), e.highLow.low),
        ...
        function(a, b, c) {
            ...
            function d(a) {
                var b, d = {
                    raw: this.data,
                    normalized: a.distributeSeries ? c.getDataArray(this.data, a.reverseData).map(function(a) {
                        return [a]
                    }) : c.getDataArray(this.data, a.reverseData)
                };
                ...
                if (a.stackBars) {
                    ...
                    b = c.getHighLow([i], a)
                } else b = c.getHighLow(d.normalized, a);
                b.high = +a.high || (0 === a.high ? 0 : b.high), b.low = +a.low || (0 === a.low ? 0 : b.low);
                var j, k, l, m, n, o = c.createChartRect(this.svg, a, f.padding);
                k = a.distributeSeries && a.stackBars ? d.raw.labels.slice(0, 1) : d.raw.labels, a.horizontalBars ? (l = n = new c.StepAxis(c.Axis.units.y, d, o, {
                    ticks: k
                }), j = m = new c.AutoScaleAxis(c.Axis.units.x, d, o, c.extend({}, a.axisX, {
                    highLow: b,
                    referenceValue: 0
                }))) : (l = m = new c.StepAxis(c.Axis.units.x, d, o, {
                    ticks: k
                }), j = n = new c.AutoScaleAxis(c.Axis.units.y, d, o, c.extend({}, a.axisY, {
                    highLow: b,
                    referenceValue: 0
                })));
                ...
                l.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter), j.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter), d.raw.series.forEach(function(b, e) {
                    ...
                    f = a.distributeSeries && !a.stackBars ? l.axisLength / d.normalized.length / 2 : a.distributeSeries && a.stackBars ? l.axisLength / 2 : l.axisLength / d.normalized[e].length / 2, h = g.elem("g"), h.attr({
                        ...
                        var m, n, r, s;
                        if (s = a.distributeSeries && !a.stackBars ? e : a.distributeSeries && a.stackBars ? 0 : k, m = a.horizontalBars ? {
                                x: o.x1 + j.projectValue(g || 0, k, d.normalized[e]),
                            ...
                            }, m[l.units.pos] += f * (a.horizontalBars ? -1 : 1), m[l.units.pos] += a.stackBars || a.distributeSeries ? 0 : i * a.seriesBarDistance * (a.horizontalBars ? -1 : 1), r = q[k] || p, q[k] = r - (p - m[l.counterUnits.pos]), void 0 !== g) {
                            var t = {};
                            t[l.units.pos + "1"] = m[l.units.pos], t[l.units.pos + "2"] = m[l.units.pos], t[l.counterUnits.pos + "1"] = a.stackBars ? r : p, t[l.counterUnits.pos + "2"] = a.stackBars ? q[k] : m[l.counterUnits.pos], n = h.elem("line", t, a.classNames.bar).attr({
                                value: g,
        ...
        function(a, b, c) {
            ...
            function e(a) {
                ...
                this.svg = c.createSvg(this.container, a.width, a.height, a.donut ? a.classNames.chartDonut : a.classNames.chartPie), b = c.createChartRect(this.svg, a, g.padding), e = Math.min(b.width() / 2, b.height() / 2), h = a.total || k.reduce(function(a, b) {
                    return a + b
                }, 0), e -= a.donut ? a.donutWidth / 2 : 0, f = "outside" === a.labelPosition || a.donut ? e : "center" === a.labelPosition ? 0 : e / 2, f += a.labelOffset;
                for (var l = {
                        x: b.x1 + b.width() / 2,
                        y: b.y2 + b.height() / 2
                    }, m = 1 === this.data.series.filter(function(a) {
                        return a.hasOwnProperty("value") ? 0 !== a.value : 0 !== a
                    }).length, n = 0; n < this.data.series.length; n++) {
                    var o = this.data.series[n];
                    i[n] = this.svg.elem("g", null, null, !0), i[n].attr({
                        "series-name": o.name
                    }, c.xmlNs.uri), i[n].addClass([a.classNames.series, o.className || a.classNames.series + "-" + c.alphaNumerate(n)].join(" "));
                    var p = j + k[n] / h * 360;
                    p - j === 360 && (p -= .01);
                    var q = c.polarToCartesian(l.x, l.y, e, j - (0 === n || m ? 0 : .2)),
                    ...
                    if (t.attr({
                            value: k[n],
                            meta: c.serialize(o.meta)
                        }, c.xmlNs.uri), a.donut && t.attr({
                        ...
                        if (v || 0 === v) {
                            var w = i[n].elem("text", {
                                dx: u.x,
                                dy: u.y,
                                "text-anchor": d(l, u, a.labelDirection)
                            }, a.classNames.label).text("" + v);
                            this.eventEmitter.emit("draw", {
                                type: "label",
                                index: n,
                                group: i[n],
